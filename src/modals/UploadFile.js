      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <View style={styles.uploadCrossView}>
            <Text style={styles.uploadCrossText}>
          ...
          <View style={styles.takePhotoGalleryView}>
            <TouchableOpacity
              ...
              <View style={styles.blackView}>
                <Image source={imagePath.camera2} />
              </View>
              <Text style={styles.takeText}>{i18n.t('upload.take')}</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.takeText}>{i18n.t('upload.gallery')}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
