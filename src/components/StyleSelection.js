...
export default function StyleSelections({onSelectedStyle, styless}) {
  const [selectedCategories, setSelectedCategories] = useState(styless || []);
  ...
  const handleCategorySelect = name => {
    if (selectedCategories.includes(name)) {
      ...
      setSelectedCategories(prevSelected => {
        onSelectedStyle([...prevSelected, name]);
